    ...
    try {
        ...
        const peca = await prisma.peca.create({
            data: {
                ...
                areaSuperficial: body.areaSuperficial ? parseFloat(body.areaSuperficial) : null,
                dimensoesExternas: body.dimensoesExternas || null,
                tratamentoSuperficial: body.tratamentoSuperficial || null,
                detalheTratamento: body.detalheTratamento || null,
